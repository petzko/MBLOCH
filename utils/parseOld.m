%% 
function settings = parseOld(filename)

assert(exist(filename) == 2,'the specified file does not exist. please try again'); 

optnames = {'name','shb','tch','lch','N','D','disp','Ltot','Lp','dN','Ld','Overlap','n','zUL','E1','E2','E3',...
    'O13','INJ','ULL','LLL','DEPOP','W_inj','W_ull','W_lll','W_dep','deph','Tdeph','loss','simRT','plotCtr','recordRT','nr_steps'};
n = length(optnames);
comments = '#%!';
optvals = cell(n,1)
