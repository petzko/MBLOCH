classdef DM_MODEL_3_LVL_RWA_RING_v2 < handle
    properties
        name;
    ...
    methods
        ...
        function obj  = DM_MODEL_3_LVL_RWA_RING_v2(params)
            ...
            obj.i_iu = 1; obj.i_ul = 2; obj.i_il = 3;
            
            
            obj.Tdeph_iu = params.Tdeph_iu;
            obj.Tdeph_il = params.Tdeph_il;
        ...
        function [] = prep_data(obj,W,HTB_ev)
            ...
            obj.DEPH(obj.i_iu) = 1/2*(obj.TOT_RTS(obj.INJ)+ ...
                obj.TOT_RTS(obj.ULL)) +1/obj.Tdeph_iu;
            obj.DEPH(obj.i_ul) = 1/2*(obj.TOT_RTS(obj.ULL)+...
                obj.TOT_RTS(obj.LLL))+1/obj.Tdeph_ul;
            obj.DEPH(obj.i_il) = 1/2*(obj.TOT_RTS(obj.INJ)+...
                obj.TOT_RTS(obj.LLL)) +1/obj.Tdeph_il;
            
            %obtain the energies of the core levels for the simulation
            hbar = Constants('hbar',{'time',obj.tch})/Constants('q0');
            
            E_I = HTB_ev(INJ+(INJ-1)*obj.NLVLS)/hbar;
            E_U = HTB_ev(ULL+(ULL-1)*obj.NLVLS)/hbar;
            E_L = HTB_ev(LLL+(LLL-1)*obj.NLVLS)/hbar; % in rad/ps
            
            %%%% TUNNELING transition is INJ->ULL
            obj.OMEGA = HTB_ev(ULL+(INJ-1)*obj.NLVLS)/hbar; % in rad/ps
            
            obj.E_IU = E_I-E_U; %rad/ps; 1->3 traisition freq
            obj.E_IL = E_I-E_L; %rad/ps; 1->2 transition freq
            obj.E_UL = E_U-E_L; %rad/ps  3->2 transition freq (optical transition)
            
            obj.dE_IU = -1i*obj.E_IU - obj.DEPH(obj.i_iu); %
            obj.dE_UL = +1i*(obj.E0 - obj.E_UL) - obj.DEPH(obj.i_ul); %
            obj.dE_IL = +1i*(obj.E0 - obj.E_IL)- obj.DEPH(obj.i_il); %
        ...
        function [] = propagate(obj,FIELD,dt)
            ...
            %%%% POPULATIONS
            obj.rho_i_t = 1i*obj.OMEGA.*(obj.rho_iu-conj(obj.rho_iu)) +W(ULL,INJ).*obj.rho_u + ...
            ...
            obj.rho_u_t = 1i*obj.OMEGA.*(conj(obj.rho_iu) - obj.rho_iu) +1i/2*(lmInteraction-conj(lmInteraction)) + ...
            ...
            %%%% COHERENCES
            obj.rho_iu_t = obj.dE_IU.*obj.rho_iu + 1i*obj.OMEGA.*(obj.rho_i-obj.rho_u) + ...
                1i/2.*conj(FIELD).*obj.eta_il;
            obj.rho_iu_solver.make_step(obj.rho_iu_t,dt);
            
            obj.eta_ul_t = obj.dE_UL.*obj.eta_ul + 1i/2.*FIELD.*(obj.rho_u-obj.rho_l) - ...
                1i*obj.OMEGA.*obj.eta_il;
            obj.eta_ul_solver.make_step(obj.eta_ul_t,dt);
            
            obj.eta_il_t = obj.dE_IL.*obj.eta_il +1i/2.*FIELD.*obj.rho_iu - 1i*obj.OMEGA.*obj.eta_ul;
        ...
        function steady_state = get_steady_state(obj)
            ...
            COUPLING_RATE =  2*abs(obj.OMEGA)^2*obj.DEPH(obj.i_iu)...
                /(obj.E_IU^2+obj.DEPH(obj.i_iu)^2);
            GAMMA(obj.INJ,obj.ULL) = GAMMA(obj.INJ,obj.ULL)+COUPLING_RATE;
            GAMMA(obj.ULL,obj.INJ) = GAMMA(obj.ULL,obj.INJ)+COUPLING_RATE;
