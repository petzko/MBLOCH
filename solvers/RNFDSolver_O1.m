classdef RNFDSolver_O1 < handle
    ...
    methods
        function obj = RNFDSolver_O1(N,dx,dt,direction,velocity, U_0)
            ...
            assert(velocity*dt == dx, 'RNFDsolver initialization failed. Magic time step not selected.'); 
