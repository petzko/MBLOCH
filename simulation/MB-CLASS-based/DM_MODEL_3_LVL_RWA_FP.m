classdef DM_MODEL_3_LVL_RWA_FP < handle
    ...
    methods
        ...
        function obj  = DM_MODEL_3_LVL_RWA_RING(params)
            ...
            obj.rho_ex_DC = 1/3*ones(obj.N_pts,1);
            obj.rho_spin_DC = 1/3*ones(obj.N_pts,1);
            obj.rho_grnd_DC =  1 - obj.rho_ex-obj.rho_spin;
            
            % some very small correlation
            obj.eta_eg_F = 1e-15*((rand(obj.N_pts,1)-1/2)+ ...
                1i*(rand(obj.N_pts,1)-1/2));
            obj.eta_eg_F_t = 0*obj.eta_eg_F;
            
            obj.eta_eg_B = 1e-15*((rand(obj.N_pts,1)-1/2)+ ...
                1i*(rand(obj.N_pts,1)-1/2));
            obj.eta_eg_B_t = 0*obj.eta_eg_B;
