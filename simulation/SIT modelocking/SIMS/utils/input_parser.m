...
optnames = {'name','zUL','E_UL','E_LL','E_IL','AC_energy', ... 
            'T_1','T_2','L','Lp', 'D','R', ...
            'Gamma','nTHz','tch','lch','rho_u_0','rho_l_0',...
            'linear_loss','Ncarriers_cm','HTB','Wmtx','Grnd_','Ex_','Spin_', ...
            'INJ','ULL','LLL','DEPOP','IGNORE','NLVLS','Tdeph_iu','Tdeph_ul','Tdeph_il',};
