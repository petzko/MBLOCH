function [FML_AREA,HML_AREA] = new_condition(T1g,T1a,T2g,T2a,zULg,zULa,TRT)
...
%%
g0 = gamma*linspace(gth,4*gth,30);
q0 = linspace(q0_,4*q0_,30); 
...
hml_idx = find(~isnan(HARM_DIFF)); 
HARM_DIFF = HARM_DIFF(hml_idx);
HML_AREA = trapz(HARM_DIFF)*(g0_2(2)-g0_2(1));
