function [ savename ] = runsim_RING_RNFD_multilevelHTB_dispcompPHASE( scenarioFile,simDataFile,varargin )
...
%compensate twice per round trip
compensations = 1;
...
savename = [settings.name '_' settings.scenario '_WITH_phase_compensation_' num2str(compensations) '_N_' num2str(settings.N) '_RING_RT_' num2str(settings.simRT)];
save(savename);
