classdef TL_solver2 < handle
    ...
    methods
       ...
       function propagate2(obj,J_TL1,J_TL0,t)
        ...
        obj.v_TL(1)=(obj.coeff0fBC*obj.v_TL(1)-(obj.coeff0fBC-1)/2*obj.v_TLold2(1)+obj.V_RFnew-obj.V_RFold...
                      -(obj.i_TL(1)-obj.i_TLold(1)+obj.dx*(J_TL1(1)-J_TL0(1))/4)*obj.width*obj.Zin/(obj.height*1e3))/(1/2+obj.coeff0fBC/2);          
