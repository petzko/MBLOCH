...
% dat.v_1TL(1) = 1/(rlgc.C1*dat.dx/dat.dt+1/2/dat.Zin)*...
%                     ((rlgc.C1*dat.dx/dat.dt-1/2/dat.Zin)*...
%                     dat.v_1TL(1)-dat.i_1TL(1)+dat.width*dat.dx/2*...
%                     dat.J_1TL(1)+dat.Vs/dat.Zin);
...
% dat.v_2TL(1) = 1/(rlgc.C2*dat.dx/dat.dt+1/2/dat.Zin)*...
%                     ((rlgc.C2*dat.dx/dat.dt-1/2/dat.Zin)*...
%                     dat.v_2TL(1)-dat.i_2TL(1)+dat.w2*dat.dx/2*...
%                     dat.J_2TL(1)+dat.Vs/dat.Zin);
