...
iterperrecord = 1;
%% Prep data:
load('CHCKPT_qcl183s(MLVL,11kVpCm)_(TL05)_N_TRANSMISSION_LINE_3000_FP','record_U','record_V','record_v_TL','record_i_TL','record_J_TL','dat','settings'); 
