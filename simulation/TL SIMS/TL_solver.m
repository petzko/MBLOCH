classdef TL_solver < handle
    ...
    methods
        ...
        obj.v_TL = dat.Vs/2*ones(obj.N_pts,1);    % V(0)    V(1)....   V(M)
        obj.i_TL(1:end) = 0*ones(obj.N_pts,1);    % I(1/2)  I(3/2).... I(M+1/2)
        end
        ...
        obj.v_1TL(2:end-1) = obj.v_TL(2:end-1)-obj.dt/obj.rlgc.C/obj.dx*(obj.i_TL(2:end-1)-...
                            obj.i_TL(1:end-2)-obj.width*obj.dx*J_TL(2:end-1));
        obj.i_1TL(1:end-1) = obj.i_TL(1:end-1)-obj.dt/obj.rlgc.L/obj.dx*(obj.v_TL(2:end)...
                            -obj.v_TL(1:end-1));
        ...
        function set_boundary(obj,v2old,v2new,i2new,width2,J_2TL,rlgc2)
            ...
            obj.v_TL(end) = obj.v_TL(end)-dat.dt/obj.rlgc.C/obj.dx*(-2*obj.i_TL(end-1)-...
