...
iterperrecord = 1;
%% Prep data:
load('OPTICA(GHOSTCELL-newDRY-petzko)_(12-1-0p05)_N_3000_FP_1500','record_U','record_V','record_v_TL','record_i_TL','record_J_TL','dat','settings'); 
