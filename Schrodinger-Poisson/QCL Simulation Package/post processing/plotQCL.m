function plotQCL(Psi,E,Vx,x,wavefunc_flag,modulisqr_flag,modulisqrtrunc_flag)
...
Names = {'DEPOP_2', 'DEPOP_1', 'LLL_2','LLL_1' , 'ULL','INJ_2','INJ_1'};
% indices = [7 6 5 4 3 2 1]


for ii = 1 : nlevel
    PsiPlot(:,ii) = Psi(:,ii)/(5*ii*max(Psi(:,ii))) + E(ii);
    legendInfo{ii+1} = ['|\Psi_{' Names{ii} '}|^2'];
end
